...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const contactDetails = document.getElementById('contactDetails');
    const foodContainer = document.getElementById('food-container'); // Assuming this is the main content

    // Handle "Contact" link click
    contactLink.addEventListener('click', (event) => {
        event.preventDefault(); // Prevent default link behavior

        // Hide the main content and show contact details
    ...
    homeLink.addEventListener('click', (event) => {
        ...
        // Show the main content and hide contact details
        contactDetails.style.display = 'none';
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Sample items data
    const foodItems = [
        { id: "biryani", name: "Biryani", price: 150 },
        { id: "chicken", name: "Chicken Delicious", price: 200 },
        { id: "paneer", name: "Paneer Mania", price: 120 },
        { id: "vegetable", name: "Pure Veg Dishes", price: 100 },
        { id: "chinese", name: "Chinese Corner", price: 180 },
        { id: "south-indian", name: "South Indian", price: 90 },
    ];
    ...
    // Add click listeners for food items
    document.querySelectorAll("#food-items > div").forEach(foodDiv => {
        foodDiv.addEventListener("click", () => {
            addToCart(foodDiv.id);
        });
    });
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    servicesLink.addEventListener('click', (event) => {
        ...
        // Toggle display of contact details
        if (serviveDetails.style.display === 'none' || !serviceDetails.style.display) {
...
document.addEventListener('DOMContentLoaded', () => {
    const contactLink = document.getElementById('servicesLink');
    const homeLink = document.getElementById('homeLink');
    const contactDetails = document.getElementById('serviceDetails');
    const foodContainer = document.getElementById('food-container'); // Assuming this is the main content
